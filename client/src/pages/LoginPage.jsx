...
const LoginPage = () => {
 ...
 <div className="flex   h-full">
  ...
  {/* Email */}
  <div className="flex flex-col gap-0.5 mb-5 md:gap-1.5 lg:gap-2 w-full">
  ...
  {/* Password */}
  <div className="flex flex-col gap-0.5 mb-1 md:gap-1.5 md:mb-4 lg:mb-5 lg:gap-2 w-full">
  ...
  <div className="flex mb-13 w-full">
    <Link
      to="/forgot-password"
      className="text-sky-600 font-bold ml-auto text-xs md:text-sm hover:underline"
    >
      Forgot password?
    </Link>
  </div>
  ...
  >
    ...
    {/* Signup Link */}
    <div className="text-xs flex gap-1 mt-5 md:text-sm md:gap-1.5 lg:text-base lg:gap-2 w-full">
      <h1 className="text-gray-500">Don't have an account?</h1>
     <Link
  to="/signup"
  className="text-sky-600 flex items-end font-bold hover:underline"
>
  Sign up{" "}
