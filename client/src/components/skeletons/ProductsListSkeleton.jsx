        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <div className="flex gap-3">
              <div className="h-20 w-20 bg-sky-100 rounded-lg" />
              <div className="flex flex-col gap-2 flex-1">
                <div className="h-4 w-28 bg-sky-100 rounded" />
                <div className="h-3 w-20 bg-sky-100 rounded" />
                <div className="h-3 w-24 bg-sky-100 rounded" />
                <div className="h-3 w-16 bg-sky-100 rounded" />
              </div>
            </div>
          ...
          <tbody>
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                ...
                <td className="px-4 py-2">
                  <div className="h-4 w-12 bg-sky-100 rounded" />
                </td>
                <td className="px-4 py-2">
                  <div className="h-8 w-8 bg-sky-100 rounded-full mx-auto" />
                </td>
                <td className="px-4 py-2">
                  <div className="h-8 w-8 bg-sky-100 rounded-full mx-auto" />
                </td>
